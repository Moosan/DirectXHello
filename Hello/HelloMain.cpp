...
HelloMain::HelloMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
void HelloMain::CreateWindowSizeDependentResources() 
{
...
void HelloMain::OnDeviceRestored()
{
